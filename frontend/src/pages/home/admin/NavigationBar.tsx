        ...
        <NavigationMenuList className=" gap-x-2">
          {routes.map((route) => (
            <NavigationMenuLink
              ...
              href={route.route}
              id="navlink"
              className="navlink flex flex-col items-center justify-center gap-1 px-3 py-2 rounded"
              style={{ color: location === route.route ? user.color : undefined, fontWeight: location === route.route ? 600 : undefined }}
              key={route.route}
            >
